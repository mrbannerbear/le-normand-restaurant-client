...
const MenuBanner = () => {
    return (
        <div>
        <div className="hidden bg-olive-700 min-h-[80vh] relative md:flex justify-center items-center text-white">
        ...
        <div className="md:hidden bg-olive-700 min-h-[80vh] relative flex flex-col justify-center items-center text-white">

            <div className="w-full px-6 mx-auto" data-aos="fade-in">
            <h1 className="text-4xl font-semibold mb-4">
                    Culinary Innovation Like No Other
                </h1>
                <p>William Le Normand's travels around the globe introduced him to
            ...
            <div className="w-full" data-aos="fade-in" data-aos-delay="250">
                <img className="w-[80%] relative top-12 mx-auto"
                src="https://images.unsplash.com/photo-1621327017866-6fb07e6c96ea?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            </div>
